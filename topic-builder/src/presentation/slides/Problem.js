    ...
    render() {
        return (
            <svg
                ...
                <g transform="matrix(1,0,0,1,-2188,-1318)">
                    <g
                        id="Artboard1"
                        transform="matrix(1.02759,0,0,1.00382,183.648,1314.55)">
                        <rect
                            x={1950.92}
                            y={4.112}
                            width={1868.44}
                        ...
                        <g clipPath="url(#_clip1)">
                            ...
                            <g>
                                <g transform="matrix(1.47686,0,0,1.51183,-782.886,-2412.05)">
                                    <circle
                                        cx={2380.28}
                                        cy={1715.02}
                                        r={30.479}
                                ...
                                <g transform="matrix(2.38125,0,0,2.43764,2703.88,149.804)">
                                    <path
                                        d="M20,4l-16,0c-1.1,0 -1.99,0.9 -1.99,2l-0.01,12c0,1.1 0.9,2 2,2l16,0c1.1,0 2,-0.9 2,-2l0,-12c0,-1.1 -0.9,-2 -2,-2Zm0,4l-8,5l-8,-5l0,-2l8,5l8,-5l0,2Z"
                                        style={{
                                            fill: "#fff",
                                            fillRule: "nonzero"
                                        }}
                                ...
                                <g transform="matrix(6.08689,0,0,6.23103,-14021.2,-1594.94)">
                                    <text
                                        x="2762.21px"
                                        y="282.679px"
                                        style={{
                            ...
                            <g transform="matrix(6.08689,0,0,6.23103,-14046.4,-784.558)">
                                <text
                                    x="2762.21px"
                                    y="282.679px"
                                    style={{
